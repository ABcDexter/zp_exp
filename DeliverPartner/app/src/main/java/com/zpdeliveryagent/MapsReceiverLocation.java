...
public class MapsReceiverLocation extends AppCompatActivity implements OnMapReadyCallback, TaskLoadedCallback {
    ...
    MapsReceiverLocation a = MapsReceiverLocation.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(MapsReceiverLocation.this);// needed for gsp tracking
        getLastLocation();
        SharedPreferences pref = getSharedPreferences(DELIVERY_DETAILS, Context.MODE_PRIVATE);
        strDid = pref.getString(DID, "");
        String stringSrcLat = pref.getString(DSTLAT, "");
        String stringSrcLng = pref.getString(DSTLNG, "");
        ...
        new FetchURL(MapsReceiverLocation.this).execute(getUrl(src.getPosition(), dst.getPosition(), "driving"), "driving");
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent back = new Intent(MapsReceiverLocation.this, ActivityEnroute.class);
        startActivity(back);
        finish();
    }
}