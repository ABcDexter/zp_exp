...
public class ActivityHairCare extends AppCompatActivity {
...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.hair_care);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Hair Care'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Hair Care'" ;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityHairCare.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}