...
public class ActivityReadyMeals extends AppCompatActivity {
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Ready meals & mixes'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Ready meals & mixes'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityReadyMeals.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}