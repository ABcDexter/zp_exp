...
public class ActivityOilGhee extends AppCompatActivity {
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Oil & Ghee'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityOilGhee.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
