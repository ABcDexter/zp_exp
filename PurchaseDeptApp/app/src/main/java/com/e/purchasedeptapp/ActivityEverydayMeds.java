...
public class ActivityEverydayMeds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.everyday_medicine_sexual_wellness);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivityEverydayMeds.this, ActivityUpdateToServer.class);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Everyday Medicine & Sexual Wellness'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Everyday Medicine & Sexual Wellness'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityEverydayMeds.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}