...
public class ActivityDiapers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.diapers_wipes);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivityDiapers.this, ActivityUpdateToServer.class);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Diapers & Wipes'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Diapers & Wipes'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityDiapers.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}