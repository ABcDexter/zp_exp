...
public class ActivitySugarSweetners extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.sugar_sweetners);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Sugar & Sweetners'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Sugar & Sweetners'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivitySugarSweetners.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}