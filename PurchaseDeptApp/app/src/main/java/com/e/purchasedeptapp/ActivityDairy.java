...
public class ActivityDairy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.dairy);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Dairy'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Dairy'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityDairy.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}