...
public class ActivityFrozenVeg extends AppCompatActivity {
...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.frozen_packaged_veg);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivityFrozenVeg.this, ActivityUpdateToServer.class);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Frozen packaged Veg'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Frozen packaged Veg'" ;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityFrozenVeg.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}