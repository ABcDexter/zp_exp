...
public class ActivityFlourGrainsPulses extends AppCompatActivity {
...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.flour_grains_pulses);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivityFlourGrainsPulses.this, ActivityUpdateToServer.class);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Flour / Grains / Pulses'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Flour / Grains / Pulses'" ;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityFlourGrainsPulses.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}