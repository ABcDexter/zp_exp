...
public class ActivityBaking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.baking_essentials);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Baking Essentials'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Baking Essentials'";
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityBaking.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}