...
public class ActivityMiscHousehold extends AppCompatActivity {
...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.misc_household);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivityMiscHousehold.this, ActivityUpdateToServer.class);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Misc Household'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Misc Household'" ;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityMiscHousehold.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}