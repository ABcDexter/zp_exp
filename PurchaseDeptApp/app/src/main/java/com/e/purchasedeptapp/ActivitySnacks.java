...
TextView textView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText(R.string.snacks);
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivitySnacks.this, ActivityUpdateToServer.class);
    ...
    private void searchContact(String word) {
        ...
        Cursor cursorEmployees = mDatabase.rawQuery("SELECT * FROM products WHERE category = 'Snacks'" + " AND name" + " like ?", new String[]{"%" + word + "%"});
    ...
    private void showEmployeesFromDatabase() {
        ...
        String query = "SELECT * FROM products WHERE category = 'Snacks'" ;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivitySnacks.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}