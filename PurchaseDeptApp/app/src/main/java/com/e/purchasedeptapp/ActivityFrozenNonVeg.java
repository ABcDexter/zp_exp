...
public class ActivityFrozenNonVeg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent update = new Intent(ActivityFrozenNonVeg.this, ActivityUpdateToServer.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent home = new Intent(ActivityFrozenNonVeg.this, ActivityHome.class);
        startActivity(home);
        finish();
    }
}